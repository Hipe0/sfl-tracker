...
const FoodTooltip = ({ foodName, farmData }) => {
  ...
  return (
    <div className="absolute left-0 top-full mt-2 w-max max-w-[500px] bg-slate-900 border border-amber-500/40 p-3 rounded-lg shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-[100] text-xs text-slate-300 pointer-events-none">
